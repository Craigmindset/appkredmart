...
export default function SiteHeader() {
  ...
  return (
    <>
      {/* Top bar with truck icon and Return Policy */}
      <div className="w-full bg-blue-900 text-white text-xs py-1 flex items-center justify-end gap-4 pr-4">
        ...
        <span className="hidden sm:inline-block h-4 border-l border-blue-700 mx-2"></span>
        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center justify-end gap-2">
              {/* Mobile icons - Country, Login, User Profile */}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 flex items-center gap-2">
                    <Input
                      ...
                      className="w-full min-w-[400px] sm:min-w-[500px] md:min-w-[600px]"
