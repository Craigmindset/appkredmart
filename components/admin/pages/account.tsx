...
import { User, Mail, Phone, MapPin, Shield, Key, UserPlus, Send, Eye, EyeOff, Camera, Save, Users } from "lucide-react"
...
export default function AccountAdminPage() {
  ...
  const teamMembers = [
    { id: 1, name: "John Doe", email: "john@kredmart.com", role: "Manager", status: "Active", joinDate: "2024-01-15" },
    {
      id: 2,
      name: "Jane Smith",
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your profile, security, and team access</p>
        </div>
      </div>
              ...
              <form onSubmit={handleProfileUpdate} className="space-y-6">
                ...
                <div className="flex items-center gap-6">
                  <div className="relative">
                    ...
                    <Button type="button" size="sm" className="absolute -bottom-2 -right-2 h-8 w-8 rounded-full">
              ...
              <form onSubmit={handleRoleAssignment} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={(e) => setRoleData((prev) => ({ ...prev, email: e.target.value }))}
                        className="pl-10"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <Select
                      value={roleData.role}
                      onValueChange={(value) => setRoleData((prev) => ({ ...prev, role: value }))}
                    >
                      <SelectTrigger>
                ...
                <Button type="submit" disabled={isSendingInvite} className="w-full md:w-auto">
                  {isSendingInvite ? (
                    <>
                      <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2" />
                      Sending Invite...
                ...
                {teamMembers.map((member) => (
                  <div key={member.id} className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <div className="flex items-center gap-3">
                      <Badge
                        variant={
                          member.role === "Manager" ? "default" : member.role === "Marketer" ? "secondary" : "outline"
                        }
                      >
                        {member.role}
                      </Badge>
