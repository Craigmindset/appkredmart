              ...
              <div className="w-full max-w-md rounded-2xl border bg-card p-6 shadow-lg backdrop-blur-md md:p-8">
                {step === "password" ? (
                  <>
                    ...
                    <div className="text-xs font-medium text-muted-foreground">{"FINAL STEP"}</div>
                    <h2 className="mt-1 text-xl font-semibold tracking-tight md:text-2xl">{"Create your password"}</h2>
                    ...
                    <form onSubmit={onCreate} className="mt-6 space-y-4">
                      ...
                      <Button type="submit" className="mt-2 h-11 w-full" disabled={loading || password !== confirm}>
                  ...
                  <>
                    ...
                    <div className="text-xs font-medium text-muted-foreground">{"GET STARTED"}</div>
                    <h2 className="mt-1 text-xl font-semibold tracking-tight md:text-2xl">{"Create account"}</h2>
