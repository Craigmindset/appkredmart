  ...
  const handleAcceptLoan = async () => {
    try {
      ...
      const response = await fetch(
        `/api/loans/applications/${applicationId}/accept`,
        {
          method: "POST",
        }
      );
    ...
    switch (applicationDetails?.status) {
      ...
      default:
        return {
          ...
          message:
            "Your loan application is being processed. We'll notify you once it's complete.",
        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-semibold">
                  ${applicationDetails?.loanAmount?.toFixed(2)}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className={`font-semibold capitalize ${statusInfo.color}`}>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-semibold">
                    {applicationDetails?.providerResponse?.interestRate}% per
                    month
                  </p>
                </div>
                <div>
                  ...
                  <p className="font-semibold">
                    {applicationDetails?.providerResponse?.repaymentTerms}
                  </p>
                </div>
                <div>
                  <span className="text-green-700">Provider Loan ID:</span>
                  <p className="font-semibold">
                    {applicationDetails?.providerResponse?.providerLoanId}
                  </p>
                </div>
                <div>
                  ...
                  <p className="font-semibold">
                    $
                    {applicationDetails?.providerResponse?.approvedAmount?.toFixed(
                      2
                    )}
                  </p>
                </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
              ...
              <p className="text-red-700">
                {applicationDetails?.reason ||
                  "Credit assessment did not meet requirements"}
              </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            {applicationDetails?.status === "rejected" && (
              <>
                <Link href="/checkout" className="flex-1">
                  <Button className="w-full bg-[#466cf4] hover:bg-[#3a5ce0]">
            ...
            {applicationDetails?.status === "pending_review" && (
              <div className="text-center">
                <p className="text-gray-600 mb-4">
                  We'll send you an email once your application is processed.
                </p>
                <Link href="/">
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="text-sm text-blue-800">
                ...
                <ul className="space-y-1">
                  ...
                  <li>
                    • Your order will be processed immediately upon loan
                    acceptance
                  </li>
                  <li>
                    • Repayment will be automatically deducted from your linked
                    account
                  </li>
                  <li>
                    • Contact support if you have any questions about your loan
                  </li>
                </ul>
              </div>
            </div>
